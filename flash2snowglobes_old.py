...
alpha = [0, ]  # just reusing "alpha" to distinguish stir/lab/aprox model sets
...
for a in alpha:
    models_path = '/mnt/research/SNAPhU/STIR/run_sukhbold/run_14may19_a1.25'
    ...
    for m in mass:
        ...
        dat_filename = f'stir2_14may19_s{m}_alpha1.25.dat'
